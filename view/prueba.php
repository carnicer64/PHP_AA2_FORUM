                                        ...
                                        if(isset($_SESSION["user"])){
                                            if(isset($_SESSION["role"])){
                                                if($_SESSION["role"] == "admin"){
                                                    ...
                                                    <a class="btn btn-sm btn-outline-primary" href="registerThread.php?topicID=<?php echo $thread->getTopicID() ?>&edit=true&message=<?php echo $tem["message"]; ?>&threadID=<?php echo $tem["threadId"]; ?>">Edit thread</a>
                                                    <?php
