...
if(isset($_GET["threadRegister"])){
    if ($_GET["threadRegister"] == "correct"){
        ?>
    ...
    if(isset($_SESSION["user"])){
        if(isset($_GET["edit"])){
            ?>
            <h2 class="text-center">Thread edit</h2>
            <div class="p-5">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    <div class="form-group text-left">
                        <label for="name">* Name:</label>
                        <input id="name" class="form-control" type="text" name="name" <?php echo 'value=' .$_GET["name"] ?>>
                    ...
                    <div class="form-group text-left">
                        <br>
                        <input type="submit" name="editThread" value="Edit" class="btn btn-success py-2">
                    </div>
                </form>
            </div>
            <?php
            ...
            ?>
            <h2 class="text-center">Thread register</h2>
            <div class="p-5">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    <div class="form-group text-left">
                        <label for="name">* Name:</label>
                    ...
                    <div class="form-group text-left">
                        <br>
                        <input type="submit" name="registerThread" value="Register" class="btn btn-success py-2">
                    </div>
                </form>
            </div>
            <?php
